...
namespace Affecto.PositiveFeedback.Api.Tests
{
    ...
    public class EmployeeMapperTests
    {
        ...
        public void FirstNameIsMapped()
        {
            ...
            source = new Application.Employee(Guid.NewGuid(), "lastName", name, "title", null);
        ...
        public void TitleIsMapped()
        {
            ...
            source = new Application.Employee(Guid.NewGuid(), "lastName", "firstName", title, null);
        ...
        public void LocationIsMapped()
        {
            ...
            source = new Application.Employee(Guid.NewGuid(), "lastName", "firstName", "title", location);
